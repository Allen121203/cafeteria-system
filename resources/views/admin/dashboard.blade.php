...
<div class="w-full min-h-screen overflow-hidden space-y-6 mx-auto max-w-full md:max-w-none md:ml-0 md:mr-0" style="max-width: calc(100vw - 12rem);">
    ...
    <div class="bg-gradient-to-r from-green-500 to-green-600 text-white p-6 rounded-xl shadow-lg">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-xl font-bold">Hello, <span class="text-green-100">{{ Auth::user()->name }}</span></h1>
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-yellow-600 mt-1">{{ $pendingReservations }}</p>
                </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-orange-600 mt-1">{{ $menusSold }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            <div class="bg-gradient-to-r from-red-500 to-red-600 text-white p-4">
                <div class="flex items-center">
                    ...
                    <h3 class="text-lg font-semibold">Out of Stock Items</h3>
                </div>
            </div>
            <div class="p-4">
                <ul class="space-y-3">
